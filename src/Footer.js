        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-green-200">
              <a href="https://www.facebook.com" aria-label="Facebook" className="hover:text-white">
              ...
              <a href="https://x.com" aria-label="Twitter" className="hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 w-6 text-white">
              ...
              <a href="https://www.instagram.com" aria-label="Instagram" className="hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 w-6 text-white">
